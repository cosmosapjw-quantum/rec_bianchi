...
5. **Primitive HYREC operator and BackgroundSnapshot/RadiationFeedback trajectory interface** — **IN PROGRESS**.
   ...
   - **PR-05B2 NEXT:** source-identical causal characteristic-history block with exact `fplus_from_fminus` interpolation, accepted-step append/rollback/restart, analytic stencil JVP and coupling to the rank-one local DAE.
   - **PR-05B3:** joint primitive atomic/radiation replacement of Sobolev, native `A1s` diffusion, completed/Schur `Tvv` and scalar history feedback only where residual, Jacobian and conservation ownership close together.
