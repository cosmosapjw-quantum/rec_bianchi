...
5. **Primitive HYREC operator and BackgroundSnapshot/RadiationFeedback trajectory interface** — **IN PROGRESS**.
   ...
   - **PR-05C NEXT:** fixed canonical history macro intervals with adaptive internal DAE/collision microsteps, accepted-step commit only at macro endpoints, event-localized interface/stencil crossings, integrator restart and timestep refinement. No FLRW history-parity claim yet.
