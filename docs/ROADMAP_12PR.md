...
5. **Primitive HYREC operator and BackgroundSnapshot/RadiationFeedback trajectory interface** — **IN PROGRESS**.
   ...
   - **PR-05C2 NEXT:** couple COM-KHW, split-domain interface and actual `BackgroundSnapshot` characteristics; close global number/energy/four-force and refinement gates. No FLRW history-parity claim yet.
